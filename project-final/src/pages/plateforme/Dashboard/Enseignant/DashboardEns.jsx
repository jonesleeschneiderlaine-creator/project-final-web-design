// src/pages/plateforme/Dashboard/Enseignant/DashboardEns.jsx
...
const STATISTIQUES = [
  { id: 'cours', icone: '📖', titre: 'Cours publiés', valeur: '8', sousTitre: '+1 ce mois', variante: 'marine' },
  { id: 'etudiants', icone: '👥', titre: 'Étudiants', valeur: '342', sousTitre: '↑ 28 nouveaux', variante: 'vert' },
  { id: 'completion', icone: '✅', titre: 'Complétion', valeur: '74%', sousTitre: '↑ 5% ce mois', variante: 'orange' },
  { id: 'score', icone: '⭐', titre: 'Score quiz', valeur: '81%', sousTitre: 'Tous cours', variante: 'violet' },
];

const COURS = [
  { id: 1, icone: '📘', titre: 'Mathématiques Avancées', nbEtudiants: 124, completion: 78, scoreMoyen: 84, statut: 'publie' },
  { id: 2, icone: '🔬', titre: 'Sciences Naturelles', nbEtudiants: 89, completion: 61, scoreMoyen: 77, statut: 'publie' },
  { id: 3, icone: '📝', titre: 'Français', nbEtudiants: 67, completion: 82, scoreMoyen: 91, statut: 'publie' },
  { id: 4, icone: '🏛️', titre: "Histoire d'Haïti", nbEtudiants: 42, completion: 45, scoreMoyen: 73, statut: 'brouillon' },
  { id: 5, icone: '⚗️', titre: 'Chimie Générale', nbEtudiants: 20, completion: 30, scoreMoyen: null, statut: 'en_cours' },
];

const ACTIVITES = [
  { id: 1, type: 'inscription', texte: 'Jean Paul inscrit à Maths Avancées', temps: '5 min' },
  { id: 2, type: 'quiz', texte: 'Marie Louis — quiz Chapitre 3 terminé', temps: '22 min' },
  { id: 3, type: 'commentaire', texte: 'Commentaire sur Français leçon 2', temps: '1h' },
  { id: 4, type: 'certificat', texte: "5 certificats délivrés aujourd'hui", temps: '3h' },
];
